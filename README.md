...
See [v1.7.9 release notes](docs/CAK_FOUNDRY_RELEASE_NOTES_1.7.9.md), [v1.7.8 notes](docs/CAK_FOUNDRY_RELEASE_NOTES_1.7.8.md), [bug report](docs/AURORA_CAK_FOUNDRY_v1.7.8_BUG_REPORT.md), and [fix report](docs/AURORA_CAK_FOUNDRY_v1.7.8_FIX_REPORT.md).
